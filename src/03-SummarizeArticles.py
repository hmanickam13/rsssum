...
if __name__ == '__main__':
    ...
    try:
        ...
        if today_date in existing_status and 'GetArticles' in existing_status and existing_status['GetArticles']['status'] == 'Failed':
            status_data = {
                'status': 'Failed',
                'message': 'GetArticles failed so this has not run'
            }
        elif today_date in existing_status and 'GetArticles' in existing_status and existing_status['GetArticles']['status'] == 'Failed':
            try:
